...
# python run.py --model default --first ./images/second.png --second ./images/first.png --out ./out2.flo
...
def estimate(tenFirst, tenSecond):
	...
	assert (intHeight == 720)  # remember that there is no guarantee for correctness, comment this line out if you acknowledge this and want to continue
...
if __name__ == '__main__':
	...
	# print(tenFirst.shape)#torch.Size([3, 720, 1280])
	# print(tenSecond.shape)#torch.Size([3, 720, 1280])

	tenOutput = estimate(tenFirst, tenSecond)
	# print(tenOutput.shape)#torch.Size([2, 720, 1280])optical flow
